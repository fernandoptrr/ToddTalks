...
var achievements = [
    ...
    Achievement(id: "test1",imagePath: "achievement1", name: "Stage H", date: Date(), body: "Hore! Kamu berhasil mengucapkan kata dengan huruf H dengan sangat baik!", isEmpty: true),
